...
:   
    ...
    * * * * *
    ...
    It is safe to transfer the entire directory or any individual
    ...
    "This is a joint account controlled by X owners. You can send up to
    ...
    We can list the keys within the wallet simply by using the list
    command:
